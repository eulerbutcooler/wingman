...
export async function generateCourseSummary(
  ...
  try {
    const result = await generateText({
      ...
      system: `You are "Wingman", a virtual teaching assistant for students at the Indian Naval Institute of Aeronautical Technology (NIAT). You help students understand aeronautical engineering and naval technology concepts. 

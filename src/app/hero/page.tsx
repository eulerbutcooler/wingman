...
export default function Hero() {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden scrollbar-hide">
      ...
      <div
        className="relative z-10 flex flex-col pt-32 md:pt-44 gap-8 items-center px-4 md:px-0"
        style={{ isolation: "isolate" }}
      >
        <div className="w-full text-left md:w-11/12 flex flex-col lg:flex-row cta pb-28 gap-8 lg:gap-12 font-sans">
          <div className="flex flex-col justify-center gap-8 lg:gap-12 text-left">
            <motion.h1
              className="text-5xl md:text-7xl text-left font-bold text-white leading-tight"
            ...
            <motion.p
              className="text-white/80 text-xl md:text-2xl max-w-2xl leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
            >
              An AI-powered learning assistant that helps you learn and study more effectively with intelligent tutoring, personalized quizzes, and comprehensive study materials.
            </motion.p>
          </div>
        ...
        <div className="flex w-full md:w-11/12 flex-col md:flex-row cards gap-4 justify-center md:justify-evenly px-4 md:px-0">
          <Link href="/chat" className="flex-1">
            <div
              className="flex p-2 py-4 px-4 modern-card rounded-2xl md:rounded-4xl flex-col justify-evenly gap-4 cursor-pointer h-full"
            >
        ...
        <div className="flex flex-col w-full md:w-11/12 faqs gap-4 items-center justify-center px-4 md:px-0 mt-16 md:mt-20">
          {faqs.map((f) => (
            <FAQItem 
              key={f.id} 
              q={f.q} 

          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="modern-card p-4 sm:p-6 transition-all duration-300 rounded-2xl md:rounded-4xl group animate-slide-in-up">
                ...
                <p className="text-navy mb-4 text-sm sm:text-base font-medium">
              ...
              <div
                className="modern-card p-4 sm:p-6 transition-all duration-300 rounded-2xl md:rounded-4xl group animate-slide-in-up"
              ...
              <div
                className="modern-card p-4 sm:p-6 transition-all duration-300 rounded-2xl md:rounded-4xl sm:col-span-2 lg:col-span-1 group animate-slide-in-up"

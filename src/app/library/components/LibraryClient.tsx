    ...
    return (
      ...
      >
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="w-full h-1 bg-gradient-to-r from-navy to-blue-600 rounded-full mt-3 "></div>
        </div>
      </div>
    );
  }
    ...
    <div className="relative z-10 w-full md:w-11/12 pt-24 md:pt-34 px-4 md:px-6">
      ...
      <div className="flex flex-col md:flex-row md:items-start mb-8 gap-6">
        ...
        <div className="flex-1">
          <h1 className="text-2xl md:text-3xl font-bold text-black capitalize text-center md:text-left">
            {course.title}
          </h1>
      ...
      <div className="bg-white p-4 md:p-6 rounded-2xl md:rounded-4xl mb-8 animate-fade-in-scale border border-gray-200 shadow-sm">
          ...
          <>
            {course.topics.map((topic, index) => (
              <div
                ...
                className="bg-white p-4 md:p-5 rounded-2xl md:rounded-4xl cursor-pointer flex flex-col sm:flex-row justify-between sm:items-center gap-3 sm:gap-0 group animate-slide-in-up border border-gray-200 shadow-sm"
...
const LessonCard = React.memo(({ lesson, onView }: { lesson: Lesson; onView: (lesson: Lesson) => void }) => {
  ...
  return (
    <div 
      ...
      className="bg-white p-4 md:p-5 px-5 md:px-6 cursor-pointer rounded-2xl md:rounded-4xl border border-gray-200 shadow-sm"
    >
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 sm:gap-0">
        <div className="flex items-center">
          {getIcon()}
          <div className="flex flex-col">
            <span className="font-semibold capitalize text-sm md:text-base text-black">
              {lesson.title}
            </span>
        ...
        <div className="flex items-center gap-3 ml-7 sm:ml-0">
          {lesson.fileUrl && (
            <button
              ...
              className="flex items-center px-3 py-2 bg-black text-white hover:bg-gray-800 text-xs md:text-sm font-medium transition-colors rounded-lg"
            >
